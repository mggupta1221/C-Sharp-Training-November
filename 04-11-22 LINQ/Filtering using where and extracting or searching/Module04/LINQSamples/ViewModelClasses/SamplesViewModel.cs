...
namespace LINQSamples
{
  public class SamplesViewModel
  {
    ...
    public void WhereTwoFields()
    {
      ...
      if (UseQuerySyntax) {
                // Query Syntax
                Products = (from prod in Products where prod.Name.StartsWith(search) && prod.StandardCost == 38.49M select prod).ToList();
    ...
    public void First()
    {
      ...
      try {
        if (UseQuerySyntax) {
          ...
          // Method Syntax
                    value= Products.Select(prod => prod).First(prod=> prod.Color==search);
    ...
    public void Last()
    {
      ...
      try {
        if (UseQuerySyntax) {
                    ...
                    // Method Syntax
                    value = Products.Select(prod => prod).Last(prod => prod.Color == search);
    ...
    public void LastOrDefault()
    {
      ...
      if (UseQuerySyntax) {
                ...
                // Method Syntax
                value = Products.Select(prod => prod).LastOrDefault(prod => prod.Color == search);
    ...
    public void Single()
    {
      ...
      try {
        if (UseQuerySyntax) {
                    ...
                    // Method Syntax
                    value = Products.Select(prod => prod).LastOrDefault(prod => prod.ProductID == search);
    ...
    public void SingleOrDefault()
    {
      ...
      try {
        if (UseQuerySyntax) {
                    ...
                    // Method Syntax
                    value = Products.Select(prod => prod).SingleOrDefault(prod => prod.ProductID == search);
